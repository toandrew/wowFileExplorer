...
public class TabHost extends FrameLayout implements ViewTreeObserver.OnTouchModeChangeListener {
    ...
    /*package*/ boolean mIsBuiltInStyle;
...
mTabHost.addTab(TAB_TAG_1, "Hello, world!", "Tab 1");
      */
    public void setup() {
        mTabWidget = (TabWidget) findViewById(R.id.marsui_tabs);
        if (mTabWidget == null) {
            throw new RuntimeException(
                    "Your TabHost must have a TabWidget whose id attribute is 'R.id.marsui_tabs'");
        }
        ...
        mIsBuiltInStyle = mTabWidget.mIsDefaultStyle;
        ...
        mTabContent = (FrameLayout) findViewById(R.id.marsui_tabcontent);
        if (mTabContent == null) {
            throw new RuntimeException(
                    "Your TabHost must have a FrameLayout whose id attribute is "
                            + "'R.id.marsui_tabcontent'");
        }
    }
    ...
    public void addTab(TabSpec tabSpec) {
        ...
        if (mIsBuiltInStyle) {
            ...
            if (count > 0) {
                tabIndicator.setBackgroundResource(R.drawable.marsui_tab_indicator_last);
                if (count > 1) {
                    mTabWidget.getChildAt(count - 1).setBackgroundResource(
                            R.drawable.marsui_tab_indicator_middle);
                }
            } else {
                mTabWidget.setDividerDrawable(null);
                mTabWidget.setStripEnabled(false);
                mTabWidget.setGravity(Gravity.CENTER_VERTICAL);
                mTabWidget.setBackgroundResource(R.drawable.marsui_titlebar_tabhost_bg);

                tabIndicator.setBackgroundResource(R.drawable.marsui_tab_indicator_first);
            }

            tabIndicator.getLayoutParams().height = getResources().getDimensionPixelSize(
                    R.dimen.marsui_tab_indicator_height);
        }
    ...
    private class LabelIndicatorStrategy implements IndicatorStrategy {
        ...
        public View createIndicatorView() {
            ...
            View tabIndicator = inflater.inflate(R.layout.marsui_tab_indicator,
                    mTabWidget, // tab widget is the parent
                    false); // no inflate params

            final TextView tv = (TextView) tabIndicator.findViewById(R.id.marsui_tab_indicator_title);
            tv.setText(mLabel);

            if (context.getApplicationInfo().targetSdkVersion <= Build.VERSION_CODES.DONUT) {
                // Donut apps get old color scheme
                tabIndicator.setBackgroundResource(R.drawable.marsui_tab_indicator_v4);
                tv.setTextColor(context.getResources().getColorStateList(R.color.marsui_tab_indicator_text_v4));
            }
    ...
    private class LabelAndIconIndicatorStrategy implements IndicatorStrategy {
        ...
        public View createIndicatorView() {
            ...
            if (TextUtils.isEmpty(mLabel)) {
                ...
                mIsBuiltInStyle = false;
            } else {
                tv.setVisibility(View.VISIBLE);
                tv.setText(mLabel);
            }

            final ImageView iconView = (ImageView) tabIndicator.findViewById(R.id.marsui_tab_indicator_icon);
            if (mIsBuiltInStyle) {
