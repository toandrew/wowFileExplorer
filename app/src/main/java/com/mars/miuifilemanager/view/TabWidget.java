...
public class TabWidget extends LinearLayout implements OnFocusChangeListener {
    ...
    public TabWidget(Context context, AttributeSet attrs, int defStyle) {
        ...
        if ((getBackground() != null) || (!mDrawBottomStrips) || (mDividerDrawable != null)
                || (mLeftStrip != null) || (mRightStrip != null)) {
        ...
        if (context.getApplicationInfo().targetSdkVersion <= Build.VERSION_CODES.DONUT) {
            ...
            if (mLeftStrip == null) {
                mLeftStrip = resources.getDrawable(
                        R.drawable.marsui_tab_bottom_left_v4);
            }
            if (mRightStrip == null) {
                mRightStrip = resources.getDrawable(
                		R.drawable.marsui_tab_bottom_right_v4);
            }
        } else {
            // Use modern color scheme for Eclair and beyond
            if (mLeftStrip == null) {
                mLeftStrip = resources.getDrawable(
                		R.drawable.marsui_tab_bottom_left);
            }
            if (mRightStrip == null) {
                mRightStrip = resources.getDrawable(
                		R.drawable.marsui_tab_bottom_right);
            }
        }
    ...
    public void setRightStripDrawable(int resId) {
        mRightStrip = getResources().getDrawable(resId);
        requestLayout();
        invalidate();
    }
